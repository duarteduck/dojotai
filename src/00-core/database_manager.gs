...
// ============================================================================
// CLASSE REMOVIDA: SessionManager - database_manager.gs:2573-2846 (274 linhas)
//
// Motivo: Código duplicado/não utilizado - substituído por session_manager.gs
// - Esta classe usava PropertiesService (memória) em vez de Sheets
// - Única referência: forceLogoutUser() em auth.gs (função órfã nunca chamada)
// - Validação de limite de sessões migrada para session_manager.gs (linhas 64-87)
// - Sistema atual usa session_manager.gs que persiste em planilha 'sessoes'
//
// Funcionalidades migradas:
// - createSession() → session_manager.gs:44-123
// - validateSession() → session_manager.gs:131-191
// - destroySession() → session_manager.gs:199-235
// - getUserSessions() → session_manager.gs:342-386 (MIGRADO EM 02/10/2025)
// - cleanupExpiredSessions() → session_manager.gs:243-287
// - getSessionStats() → Não migrado (feature não utilizada no sistema)
//
